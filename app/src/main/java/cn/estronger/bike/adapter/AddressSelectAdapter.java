...
public class AddressSelectAdapter extends RecyclerView.Adapter<AddressSelectAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public AddressSelectAdapter(Context context, ArrayList<SearchHistorysBean> datas) {
        this.datas = datas;
    ...
    public AddressSelectAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_seach_addr, parent, false);
