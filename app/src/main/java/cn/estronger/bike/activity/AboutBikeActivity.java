...
public class AboutBikeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_about_bike);
        x.view().inject(this);
    ...
    private void init() {
        ...
        tv_title.setText("关于单车");
    }

    @Event(value = {R.id.iv_back, R.id.rl_realname_no_pass, R.id.rl_realname_isexist})
